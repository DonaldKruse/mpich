...
{
    MPID_THREAD_CS_ENTER(VCI, comm_ptr->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
    MPL_strncpy(comm_ptr->name, comm_name, MPI_MAX_OBJECT_NAME);
    MPID_THREAD_CS_EXIT(VCI, comm_ptr->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
    return MPI_SUCCESS;
}
                               ...
                               MPIR_Comm ** new_intercomm_ptr)
{
    ...
    MPID_THREAD_CS_ENTER(VCI, local_comm_ptr->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
    ...
    MPID_THREAD_CS_EXIT(VCI, local_comm_ptr->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
                               ...
                               uint64_t remote_lpid, int is_low_group, MPIR_Comm ** newcomm)
{
    ...
    MPID_THREAD_CS_ENTER(VCI, comm_self->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
    ...
    MPID_THREAD_CS_EXIT(VCI, comm_self->mutex, MPIR_THREAD_VCI_HANDLE_MUTEX_ID);
